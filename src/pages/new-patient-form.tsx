...
const NewPatientForm: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<NewPatientFormProps> = async (
    ...
    for (let item in data) {
      if (data.hasOwnProperty(item)) {
        ...
        if (data[item as keyof NewPatientFormProps] === "No") {
          delete data[item as keyof NewPatientFormProps];
        }
  ...
  const inputClassName =
    "mb-2 ml-4 mt-4 rounded-xl focus:border-none focus:outline-brand-lightest focus:ring-1 placeholder-sm";
  const selectClassName =
    "ml-4 mb-2 rounded-xl focus:border-none focus:outline-brand-lightest focus:ring-1 text-md";
  ...
  return (
    <div>
      ...
      <div className="flex flex-col w-[calc(10% - 10px)] mx-12 my-5 lg:max-w-5xl lg:mx-auto">
        ...
        >
          <p className="ml-4">
            <span className="text-red-500">*</span> marked are required fields.
          </p>
